...
const Sidenav = () => {
  return (
    <>
      <div className="w-[20%] h-full border-r-2 border-zinc-400 p-10 overflow-y-hidden">
        ...
        <nav className="mb-6 flex flex-col gap-3 text-zinc-400 text-xl">
          ...
          <Link
            to="/trending"
            className="hover:bg-[#6556CD] duration-300 hover:text-white rounded-lg p-5"
          >
        ...
        <nav className="flex flex-col gap-3 text-zinc-400 text-xl">
          ...
          <Link className="hover:bg-[#6556CD] text-lg duration-300 hover:text-white rounded-lg p-3">
